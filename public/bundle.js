...
contenedorCategorias.addEventListener("click", (e) => {
    ...
    if (e.target.closest("a")) {
        ...
        //con e.target accedemos a la categoria que le dimos click
...
galeria.addEventListener("click", (e) => {
   ...
   // con dataset accedemos a los atributos que tienen data en sus clases en el html
   //peguntamos si hay un boton si tiene dataset y la ccion
